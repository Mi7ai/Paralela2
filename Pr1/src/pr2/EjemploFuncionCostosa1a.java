...
// ============================================================================
  ...
  public static void main( String args[] ) {
    ...
    // Ejercicio 1.1 y 1.2
  /*
    //Thread[] hc = new HebraCiclica[numHebras]; //cambiar esta parte para poner en funcionamiento las hebras ciclicas
    Thread[] hc = new HebraBloques[numHebras];
    
    for (int i=0; i<numHebras; i++) {
    	//hc[i] = new HebraCiclica(i, numHebras, n); //cambiar esta parte para poner en funcionamiento las hebras ciclicas
    	hc[i] = new HebraBloques(i, numHebras, n);
    	hc[i].start();
    }
  ...
  */
    ...
    Thread[] vtc2 = new HebraCiclica2[numHebras];

    for (int i=0; i<numHebras; i++) {
    	vtc2[i] = new HebraCiclica2(i, numHebras, n, vectorX, vectorY);
    	vtc2[i].start();
    }
 ...
 // --------------------------------------------------------------------------
    ...
    Thread[] vtb2 = new HebraBloques2[numHebras];

    for (int i=0; i<numHebras; i++) {
    	vtb2[i] = new HebraBloques2(i, numHebras, n, vectorX, vectorY);
    	vtb2[i].start();
    }
